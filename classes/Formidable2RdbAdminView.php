...
//		}
	...
	public function admin_menu() {
		add_menu_page( Formidable2RdbManager::t( "Formidable2Rdb" ), Formidable2RdbManager::t( "Formidable2Rdb" ), ( is_network_admin() ) ? 'manage_network' : 'manage_options', Formidable2RdbManager::getSlug(), array( $this, 'menu_manage' ), F2M_IMAGE_PATH . "rdb-20.png" );
...
//		add_settings_field( 'connection_wp_data', Formidable2RdbManager::t( '<b>Use WP Connection</b>' ), array( $this, 'connection_wp_data' ), Formidable2RdbManager::getSlug(), 'section_connection' );
	...
	private function get_view_for( $setting, $type = "text" ) {
		...
		echo "<input name='formidable2rdb[" . $setting . "]' id='f2r_admin_" . $setting . "' type='" . $type . "' value='" . $data . "'/>";
	}
