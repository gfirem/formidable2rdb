...
class Formidable2RdbAdminView {
	//Todo  show error connection message only on formidable2rdb-screen
...
//		}
	...
	private function create_main_menu( $call_back ) {
		add_menu_page( Formidable2RdbManager::t( "Formidable2Rdb" ), Formidable2RdbManager::t( "Formidable2Rdb" ), ( is_network_admin() ) ? 'manage_network' : 'manage_options', Formidable2RdbManager::getSlug(), array(
			$this,
			$call_back
		), F2M_IMAGE_PATH . "rdb-20.png" );
	}
					...
					if ( ! empty( $this->rdb_instance ) ) {
						...
						foreach ( $tables as $table ) {
							if ( $this->rdb_instance->exist_table( $table["full_table"] ) ) {
								...
								add_submenu_page( Formidable2RdbManager::getSlug(), Formidable2RdbManager::t( "Table: " ) . $table["table"], $menu_name, 'manage_options', Formidable2RdbManager::getSlug() . '_' . strtolower( $table["full_table"] ), array(
									$this,
									'show_table'
								) );
							} else {
	...
	public function register_admin_settings() {
		try {
			...
			$sectionId = 'SectionPage_Id';
			register_setting( Formidable2RdbManager::getSlug(), $slug, array(
				$this,
				"process_settings"
			) );
			//TODO Insert the settings
...
//
//				add_settings_field( Formidable2RdbManager::getShort() . 'version', Formidable2RdbManager::t( "Version: " ), array(
//					$this,
//					'version'
//				), Formidable2RdbManager::getSlug(), 'section_key' );
//				add_settings_field( Formidable2RdbManager::getShort() . 'licence_key', Formidable2RdbManager::t( "Order key: " ), array(
//					$this,
//					'order_key'
//				), Formidable2RdbManager::getSlug(), 'section_key' );
//				add_settings_field( Formidable2RdbManager::getShort() . 'status', Formidable2RdbManager::t( "Key status: " ), array(
//					$this,
//					'status'
//				), Formidable2RdbManager::getSlug(), 'section_key' );
//
...
//
//				add_settings_field( 'debug_data', Formidable2RdbManager::t( '<b>Enable Debug Mode</b>' ), array(
//					$this,
//					'debug_data'
//				), Formidable2RdbManager::getSlug(), 'debug_section' );
//
//				add_settings_section( 'section_connection', Formidable2RdbManager::t( "Connection Data" ), array(
//					$this,
//					"connection_wp_data"
//				), Formidable2RdbManager::getSlug() );
//
//				foreach ( self::get_credentials_array() as $credential_key => $credential_name ) {
//					add_settings_field( $credential_key, $credential_name, array(
//						$this,
//						$credential_key
//					), Formidable2RdbManager::getSlug(), 'section_connection' );
//				}
//
//				add_settings_section( 'save_data', '', array( $this, "save_data" ), Formidable2RdbManager::getSlug() );
//
//				add_settings_section( 'section_overview', Formidable2RdbManager::t( "Tables overview" ), array(
//					$this,
//					'section_overview_tables'
//				), Formidable2RdbManager::getSlug() );
//			}
		} catch ( Formidable2RdbException $ex ) {


			//TODO show  error message only on plugin admin pages
//			Formidable2RdbManager::handle_exception( $ex->getMessage(), $ex->getBody() );
		}
//      catch ( Exception $ex ) {
//			Formidable2RdbManager::handle_exception( $ex->getMessage() );
...
//	}
	...
	public function connection_db_name() {
		...
		?> <p class="submit"><input type="button" name="test" id="f2r_test_credential" class="button"
                                    value="Test Credential"> <?php
